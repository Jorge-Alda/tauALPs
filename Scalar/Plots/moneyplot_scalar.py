...
if __name__ == '__main__':
    BelleII_g2tau.textpos = (2e-2,3.8e-3)
    CMS_g2tau.name = ''
    ee3gamma_445pb.name = ''
    ee3gamma_proj.name = ''
    ...
    gammainv_proj.textpos = (1.8e-3, 2e-2)
    ...
    BESIII_gammainv.name = r'$J/\psi\to\gamma + $inv. '+ '\n(BESIII)'
    ...
    plots.make_plot([
        ...
        BaBar_Y3Stau, BESIII_3gamma, BESIII_gammainv, BelleII_gammatau,
        ee3gamma_445pb, gammainv_proj, ee3gamma_proj, 
        ], 'moneyplot_scalar_zoomed.pdf', r'\tau', limy=(1e-3, 10), limx=(1e-3, 10))